...
class Student {
private:
    string* surname = new string{ "Kostucenko Kate" };
    string date_of_birth = "08.06.2000";
    string contact_phone = "097 368 02 37";
    string city = "³Vinnytsia";
    string country = "Ukrain";
    string name_of_the_institution = "IT Step Academy";
    string city_and_country_institution = "Vinnytsia,Ukrain";
